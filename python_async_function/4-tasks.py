#!/usr/bin/env python3
'''
module utilizes typing and asyncio packages
imports a function to generate a random task delay
function task_wait_n takes 2 integers as an argument to return a list of
...
async def task_wait_n(n: int, max_delay: int) -> List[float]:
    '''
    function task_wait_n takes two arguments:
    - n (integer)
    - max_delay (integer)
    Returns:
    - List of floats
